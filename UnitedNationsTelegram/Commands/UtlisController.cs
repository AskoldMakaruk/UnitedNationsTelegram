...
public class UtlisController : UnController
{
    ...
    public async Task Stats()
    {
        ...
        var userPlace = await context.UserCountries.CountAsync(a => a.Votes.Count(c => c.Created > date) > votes.Count(c => c.Created > date) && a.UserCountryId != country.UserCountryId && a.ChatId == country.ChatId);
